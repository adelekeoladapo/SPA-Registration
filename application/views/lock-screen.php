...
<head>
        ...
        <!-- Title -->
        <title>Modern | Login - Lock Screen</title>
                            ...
                            <div class="login-box">
                                <div class="user-box m-t-lg row">
                                    <div class="col-md-12 m-b-md">
                                        <img src="<? echo base_url(); ?>assets/theme/images/profile-menu-image.png" class="img-circle m-t-xxs" alt="">
                                    </div>
                                    <div class="col-md-12">
                                        <p class="lead no-m text-center">Welcome Back, David!</p>
                                        <p class="text-sm text-center">Enter password to unlock</p>
                                        <form class="form-inline text-center" action="http://steelcoders.com/modern/admin1/index.html">
